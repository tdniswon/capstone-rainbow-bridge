...
class OrderLinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_line" do
    assert_difference('OrderLine.count') do
      post order_lines_url, params: { order_line: { order_line_description: @order_line.order_line_description, order_line_finish_date: @order_line.order_line_finish_date, order_line_start_date: @order_line.order_line_start_date, order_line_status_id: @order_line.order_line_status_id, product_id: @order_line.product_id, special_order_notes: @order_line.special_order_notes } }
    end
